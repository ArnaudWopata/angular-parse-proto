...
MD question answering app build on with AngularJS + Parse.

***

This project is based on [ngBoilerplate](http://joshdmiller.github.com/ng-boilerplate), an opinionated kickstarter for [AngularJS](http://angularjs.org) projects.
